...
DifferentialProbabilityBound = list([0, 1, 2, 4, 7, 10, 15, 20, 24, 27, 30, 34, 38, 42, 46, 50, 55, ])
for i in range(FullRound-SearchRoundStart):
...
def Decision(Round, Probability, MatsuiRoundIndex, MatsuiCount, flag):
    ...
    for r in range(Round):
        ...
        SymbolicCNFConstraintForSbox = [
            [9, 9, 9, 9, 0, 0, 1, 1, 0, 0], [9, 9, 9, 9, 1, 0, 1, 1, 1, 0], [9, 9, 9, 0, 9, 1, 1, 0, 0, 0], [9, 9, 9, 1, 9, 1, 1, 0, 1, 0], [9, 0, 9, 9, 9, 0, 1, 0, 0, 0], [9, 1, 9, 9, 9, 0, 1, 0, 1, 0], [9, 0, 1, 1, 9, 9, 9, 9, 1, 0], [9, 1, 0, 1, 9, 9, 9, 9, 1, 0], [9, 1, 1, 0, 9, 9, 9, 9, 1, 0], [9, 0, 0, 0, 9, 9, 9, 9, 1, 0], [9, 1, 1, 1, 9, 9, 9, 9, 0, 0], [9, 0, 0, 1, 9, 9, 9, 9, 0, 0], [9, 0, 1, 0, 9, 9, 9, 9, 0, 0], [9, 1, 0, 0, 9, 9, 9, 9, 0, 0], [9, 9, 9, 0, 0, 1, 0, 1, 9, 0], [9, 9, 9, 1, 1, 1, 0, 1, 9, 0], [9, 9, 0, 9, 0, 1, 1, 1, 9, 0], [9, 9, 1, 9, 1, 1, 1, 1, 9, 0], [9, 0, 9, 9, 0, 0, 0, 1, 9, 0], [9, 1, 9, 9, 1, 0, 0, 1, 9, 0], [9, 0, 9, 0, 9, 1, 0, 0, 9, 0], [9, 1, 9, 1, 9, 1, 0, 0, 9, 0], [1, 9, 9, 9, 9, 0, 0, 0, 9, 0], [0, 9, 1, 9, 0, 9, 9, 9, 9, 0], [0, 0, 9, 9, 1, 9, 9, 9, 9, 0], [0, 9, 0, 1, 9, 9, 9, 9, 9, 0], [0, 1, 9, 0, 9, 9, 9, 9, 9, 0]]
    ...
    # Call solver cadical
    order = "/Users/xushengyuan/Documents/cadical-master/build/cadical " + "Problem-Round" + str(Round) + "-Probability" + str(Probability) + ".cnf > Round" + str(Round) + "-Probability" + str(Probability) + "-solution.out"
    os.system(order)
    # Extracting results
